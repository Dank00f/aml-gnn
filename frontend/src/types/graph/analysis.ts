...
export interface AnalysisMetadata {
  ...
  clustering_method: 'agc' | 'louvain' | 'greedy_modularity' | 'wcc'
...
export interface ClusteringResult {
  method: 'agc' | 'louvain' | 'greedy_modularity' | 'wcc'
